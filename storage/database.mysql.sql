...
VALUES
    ...
    ((SELECT id FROM casinos WHERE slug = 'aurora-vault-casino'), 'Banking', 'Vault-branded payments with instant crypto routes and fast card payouts.'),
...
VALUES
    ...
    ((SELECT id FROM casino_review_sections WHERE title = 'Banking' AND casino_id = (SELECT id FROM casinos WHERE slug = 'aurora-vault-casino')), 'fa-key', 'Vault-branded cashier prioritizes security without slowing payouts.'),
